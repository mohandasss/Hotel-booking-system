...
const HomePage = () => {
    ...
    return (
        <div className="home">
            ...
            <section>
                <header className="header-banner">
                    <div className="slideshow-container">
                        {slides.map((slide, index) => (
                            <img
                                ...
                                src={slide}
                                alt={`Slide ${index + 1}`}
                                className={`header-image ${index === currentSlide ? "active" : ""}`}
                            />
                        ))}
                    </div>
                    ...
                    <div className="animated-texts overlay-content">
                        <h1>
                            Welcome to <span className="phegon-color">Mohan Hotels</span>
                        </h1><br />
            ...
            <h2 className="home-services">Services at <span className="phegon-color">Mohan Hotels</span></h2>
